...
CREATE INDEX IF NOT EXISTS team_profiles_owner_id_idx ON public.team_profiles (owner_id);
CREATE INDEX IF NOT EXISTS team_members_team_id_idx ON public.team_members (team_id);
CREATE INDEX IF NOT EXISTS team_members_user_id_idx ON public.team_members (user_id);
CREATE INDEX IF NOT EXISTS team_members_invited_email_idx ON public.team_members (invited_email); 