            ...
            <section className="relative overflow-hidden pt-20 bg-gradient-to-b from-black via-purple-900/50 to-black min-h-[90vh] flex flex-col items-center justify-center">
                ...
                <div className="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                    ...
                    >
                        ...
                        <Link
                            to="/assessment"
                            className="inline-flex items-center px-10 py-5 rounded-lg bg-transparent border border-[#7121ef]/50 text-white text-lg font-semibold hover:bg-[#7121ef]/20 transition-all duration-200 overflow-hidden group"
                        >
                            <motion.div
                                className="flex items-center"
                                whileHover={{ scale: 1.05 }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <div className="pt-4 border-t border-gray-800/30">
                                <span className="text-[#7121ef] text-sm font-medium flex items-center">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            >
                                <Link
                                    to="/register"
                                    className="inline-flex items-center px-6 py-3 rounded-lg bg-[#7121ef] text-white font-medium hover:bg-[#8341f0] transition-all duration-200 group"
                                >
                                    <motion.div
                                        className="flex items-center"
                                        whileHover={{ scale: 1.05 }}
                        ...
                        >
                            ...
                            <Link
                                to="/register"
                                className="inline-flex items-center px-6 py-3 rounded-lg bg-[#7121ef] text-white font-medium hover:bg-[#8341f0] transition-all duration-200 overflow-hidden group"
                            >
                                <motion.div
                                    className="flex items-center"
                                    whileHover={{ scale: 1.05 }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                        <div className="space-y-4">
                            ...
                            <div className="flex space-x-4">
                                <a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">AI Policy Generation</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Compliance Tools</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Team Collaboration</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Version Control</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Document Export</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-white font-semibold text-lg mb-4">Resources</h3>
                            <ul className="space-y-2">
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Documentation</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Blog</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Tutorials</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">API Reference</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Support</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 className="text-white font-semibold text-lg mb-4">Company</h3>
                            <ul className="space-y-2">
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">About Us</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Careers</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Contact</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Privacy Policy</a></li>
                                <li><a href="#" className="text-gray-400 hover:text-[#7121ef] transition-colors text-sm">Terms of Service</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className="border-t border-gray-800/50 pt-8">
                        <div className="flex flex-col md:flex-row justify-between items-center">
                            ...
                            <div className="flex space-x-6 mt-4 md:mt-0">
                                <a href="#" className="text-gray-400 hover:text-[#7121ef] text-sm transition-colors">Privacy Policy</a>
                                <a href="#" className="text-gray-400 hover:text-[#7121ef] text-sm transition-colors">Terms of Service</a>
                                <a href="#" className="text-gray-400 hover:text-[#7121ef] text-sm transition-colors">Cookie Policy</a>
                            </div>
                        </div>
                    </div>
                </div>
